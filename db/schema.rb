...
ActiveRecord::Schema.define(version: 0) do
  ...
  create_table "fusion7_admin", primary_key: "admin_id", unsigned: true, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
  ...
  create_table "fusion7_admin_resetlog", primary_key: "reset_id", unsigned: true, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
  ...
  create_table "fusion7_article_cats", primary_key: "article_cat_id", unsigned: true, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
  ...
  create_table "fusion7_articles", primary_key: "article_id", unsigned: true, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
  ...
  create_table "fusion7_bbcodes", primary_key: "bbcode_id", unsigned: true, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
  ...
  create_table "fusion7_blacklist", primary_key: "blacklist_id", unsigned: true, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
  ...
  create_table "fusion7_comments", primary_key: "comment_id", unsigned: true, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
  ...
  create_table "fusion7_custom_pages", primary_key: "page_id", unsigned: true, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
  ...
  create_table "fusion7_download_cats", primary_key: "download_cat_id", unsigned: true, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
  ...
  create_table "fusion7_downloads", primary_key: "download_id", unsigned: true, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
  ...
  create_table "fusion7_errors", primary_key: "error_id", unsigned: true, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
  ...
  create_table "fusion7_faq_cats", primary_key: "faq_cat_id", unsigned: true, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
    t.string "faq_cat_name",        limit: 200, default: "", null: false
    t.string "faq_cat_description", limit: 250, default: "", null: false
  end

  create_table "fusion7_faqs", primary_key: "faq_id", unsigned: true, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
  ...
  create_table "fusion7_forum_attachments", primary_key: "attach_id", unsigned: true, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
  ...
  create_table "fusion7_forum_ranks", primary_key: "rank_id", unsigned: true, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
  ...
  create_table "fusion7_forums", primary_key: "forum_id", unsigned: true, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
  ...
  create_table "fusion7_infusions", primary_key: "inf_id", unsigned: true, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
  ...
  create_table "fusion7_messages", primary_key: "message_id", unsigned: true, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
  ...
  create_table "fusion7_missions", unsigned: true, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
  ...
  create_table "fusion7_news", primary_key: "news_id", unsigned: true, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
  ...
  create_table "fusion7_news_cats", primary_key: "news_cat_id", unsigned: true, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
  ...
  create_table "fusion7_operations", primary_key: "operation_id", unsigned: true, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.datetime "operation_updated_at",               default: -> { "CURRENT_TIMESTAMP" }, null: false
  end
  ...
  create_table "fusion7_operations_addons", primary_key: "addon_id", unsigned: true, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
    ...
    t.datetime "addon_updated_at",             default: -> { "CURRENT_TIMESTAMP" }, null: false
  ...
  create_table "fusion7_operations_groups", primary_key: "group_id", unsigned: true, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
    ...
    t.datetime "group_updated_at",             default: -> { "CURRENT_TIMESTAMP" }, null: false
    t.index ["operation_id"], name: "operation_id", using: :btree
  end
  ...
  create_table "fusion7_operations_pws", primary_key: "pws_id", unsigned: true, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
    ...
    t.datetime "pws_updated_at",             default: -> { "CURRENT_TIMESTAMP" }, null: false
    t.index ["operation_id"], name: "operation_id", using: :btree
  end
  ...
  create_table "fusion7_operations_slots", primary_key: "slot_id", unsigned: true, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
    ...
    t.datetime "slot_updated_at",             default: -> { "CURRENT_TIMESTAMP" }, null: false
    t.index ["group_id"], name: "group_id", using: :btree
  end

  create_table "fusion7_panels", primary_key: "panel_id", unsigned: true, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
  ...
  create_table "fusion7_photo_albums", primary_key: "album_id", unsigned: true, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
  ...
  create_table "fusion7_photos", primary_key: "photo_id", unsigned: true, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
  ...
  create_table "fusion7_poll_votes", primary_key: "vote_id", unsigned: true, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
  ...
  create_table "fusion7_polls", primary_key: "poll_id", unsigned: true, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
  ...
  create_table "fusion7_posts", primary_key: "post_id", unsigned: true, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
  ...
  create_table "fusion7_ratings", primary_key: "rating_id", unsigned: true, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
  ...
  create_table "fusion7_shoutbox", primary_key: "shout_id", unsigned: true, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
  ...
  create_table "fusion7_site_links", primary_key: "link_id", unsigned: true, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
  ...
  create_table "fusion7_sitemapxml_customlinks", primary_key: "link_id", unsigned: true, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
  ...
  create_table "fusion7_smileys", primary_key: "smiley_id", unsigned: true, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
  ...
  create_table "fusion7_submissions", primary_key: "submit_id", unsigned: true, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
  ...
  create_table "fusion7_suspends", primary_key: "suspend_id", unsigned: true, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
  ...
  create_table "fusion7_threads", primary_key: "thread_id", unsigned: true, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
  ...
  create_table "fusion7_user_field_cats", primary_key: "field_cat_id", unsigned: true, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
    t.string  "field_cat_name",  limit: 200, null: false
    t.integer "field_cat_order", limit: 2,   null: false, unsigned: true
  end

  create_table "fusion7_user_fields", primary_key: "field_id", unsigned: true, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
  ...
  create_table "fusion7_user_groups", primary_key: "group_id", unsigned: true, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
    t.string "group_name",        limit: 100, default: "", null: false
    t.string "group_description", limit: 200, default: "", null: false
  end

  create_table "fusion7_user_log", primary_key: "userlog_id", unsigned: true, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
  ...
  create_table "fusion7_users", primary_key: "user_id", unsigned: true, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
  ...
  create_table "fusion7_weblink_cats", primary_key: "weblink_cat_id", unsigned: true, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
  ...
  create_table "fusion7_weblinks", primary_key: "weblink_id", unsigned: true, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
